  ...
  const createMeeting = useMutation(
    trpc.meetings.create.mutationOptions({
      onSuccess: async (data) => {
        // invalidate the get many query: "async" is not really needed here on this function just added it to await the successof invalidation before closing the modal😊
